let city= 'Kigali';
//create  search button functionalities
let searchBar = document.getElementById('searchCity')
...
const time = new Date();
        ...
        const date = `${days[day]}, ${time.getDate()}th ${months[time.getMonth()]} ${time.getFullYear()}`;
